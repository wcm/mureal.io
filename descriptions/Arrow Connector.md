---
slug: arrow-connector
logo: /product-logos/arrow-connector.svg
title: Arrow Connector
subtitle: Draw smooth connectors that update automatically.
...
- Stay fast in crowded canvases and team collaboration sessions.
...
Example:
`Lock all connectors, resize sections, then unlock for final polish.`

## Usage & Plan

- Free forever for everyday connector workflows.
- Suitable for solo designers, product teams, and design ops use.
...
Arrow Connector is available via the Figma Marketplace.
